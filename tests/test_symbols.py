...
def test_doxygen_symbol_parsing():
    ...
    if not runner.is_available():
        pytest.skip("Doxygen not found on system")
    ...
    assert len(symbols) > 0, "Should have found some symbols"
